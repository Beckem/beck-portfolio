...
function Footer() {
  return (
    <div className="bg-black bg-opacity-20 h-full  text-white flex md:p-16 p-8 justify-around">
      <div className="md:text-3xl text-xl font-semibold text-green-400">
        𝔅𝔢𝔠𝔨𝔢𝔪
      </div>
      <p className="font-light text-sm">© Copyright 2022. All right reserved</p>
